...
```
bash <(curl -L bash <(curl -L https://github.com/Cydat/hy2/raw/main/install.sh))
```
...
## 带参数执行方式
```
bash <(curl -L bash <(curl -L https://github.com/Cydat/hy2/raw/main/install.sh)) <netstack> <port> <domain> <password>
```
如
```
bash <(curl -L bash <(curl -L https://github.com/Cydat/hy2/raw/main/install.sh)) 4 2096 bing.com d3b27d90-507d-30c0-93db-42982a5a33a7
```
